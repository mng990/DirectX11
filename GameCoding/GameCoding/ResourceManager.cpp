...
{
	{
		...
		texture->SetName(L"TeacherAhn");
		texture->Create(L"TeacherAhn.jpg");
...
void ResourceManager::CreateDefaultMaterial()
{
	...
	material->SetTexture(Get<Texture>(L"TeacherAhn"));
...
void ResourceManager::CreateDefaultAnimation()
{
	...
	shared_ptr<Animation> animation2 = make_shared<Animation>();
	animation2->Load(L"TestAnim.xml");
}
